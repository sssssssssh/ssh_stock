...
class _ResearchForwardFields:
    ...
    ret20: Mapped[float | None] = mapped_column(Float)
    ret60: Mapped[float | None] = mapped_column(Float)
    mark_ret5: Mapped[float | None] = mapped_column(Float)
    mark_ret10: Mapped[float | None] = mapped_column(Float)
    mark_ret20: Mapped[float | None] = mapped_column(Float)
    mark_ret60: Mapped[float | None] = mapped_column(Float)
    mark_trade_date5: Mapped[date | None] = mapped_column(Date)
    mark_trade_date10: Mapped[date | None] = mapped_column(Date)
    mark_trade_date20: Mapped[date | None] = mapped_column(Date)
    mark_trade_date60: Mapped[date | None] = mapped_column(Date)
    delayed_exit_trade_date5: Mapped[date | None] = mapped_column(Date)
    delayed_exit_trade_date10: Mapped[date | None] = mapped_column(Date)
    delayed_exit_trade_date20: Mapped[date | None] = mapped_column(Date)
    delayed_exit_trade_date60: Mapped[date | None] = mapped_column(Date)
    delayed_exit_price5: Mapped[float | None] = mapped_column(Float)
    delayed_exit_price10: Mapped[float | None] = mapped_column(Float)
    delayed_exit_price20: Mapped[float | None] = mapped_column(Float)
    delayed_exit_price60: Mapped[float | None] = mapped_column(Float)
    delayed_exit_delay_days5: Mapped[int | None] = mapped_column(Integer)
    delayed_exit_delay_days10: Mapped[int | None] = mapped_column(Integer)
    delayed_exit_delay_days20: Mapped[int | None] = mapped_column(Integer)
    delayed_exit_delay_days60: Mapped[int | None] = mapped_column(Integer)
    delayed_exit_ret5: Mapped[float | None] = mapped_column(Float)
    delayed_exit_ret10: Mapped[float | None] = mapped_column(Float)
    delayed_exit_ret20: Mapped[float | None] = mapped_column(Float)
    delayed_exit_ret60: Mapped[float | None] = mapped_column(Float)
    net_ret5: Mapped[float | None] = mapped_column(Float)
    net_ret10: Mapped[float | None] = mapped_column(Float)
    net_ret20: Mapped[float | None] = mapped_column(Float)
    net_ret60: Mapped[float | None] = mapped_column(Float)
    net_delayed_exit_ret5: Mapped[float | None] = mapped_column(Float)
    net_delayed_exit_ret10: Mapped[float | None] = mapped_column(Float)
    net_delayed_exit_ret20: Mapped[float | None] = mapped_column(Float)
    net_delayed_exit_ret60: Mapped[float | None] = mapped_column(Float)
